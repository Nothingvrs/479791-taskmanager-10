...
export default class TaskEdit extends AbstractSmartComponentComponent {
  constructor(task) {
    super();
    this._task = task;
  ...
  writeData() {
    ...
    task.dueDate = this._isDateShowing;
    task.repeatingDays = this._isRepeatingTask;
    task.repeatingDays = this._activeRepeatingDays;
